angular.module("templates", []).run(["$templateCache", function ($templateCache) { $templateCache.put("multiple-autocomplete-tpl.html", "<div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12 filter-div\"><div class=\"ng-ms form-item-container\">\r\n    <ul id=\"list-detail\" ng-click=\"multipleTagSelectContainer()\" role=\"presentation\" class=\"list-inline list-inline-detail\">\r\n        <li class=\"select-tag-detail\" ng-repeat=\"item in modelArr\">\r\n			<span ng-if=\"objectProperty == undefined || objectProperty == \'\'\">\r\n				{{item}} <span class=\"remove\" ng-click=\"removeAddedValues(item)\">\r\n                <i class=\"glyphicon glyphicon-remove\"></i></span>&nbsp;\r\n			</span>\r\n            <span ng-if=\"objectProperty != undefined && objectProperty != \'\'\">\r\n				{{item[objectProperty]}} <span class=\"remove\" ng-click=\"removeAddedValues(item)\">\r\n                <i class=\"glyphicon glyphicon-remove\"></i></span>&nbsp;\r\n			</span>\r\n        </li>\r\n        <li id=\"\li-tag-input-search\">\r\n            <input name=\"{{name}}\" id=\"tag-input-search\" ng-model=\"inputValue\" placeholder=\"Search for tags\" ng-keydown=\"keyParser($event)\"\r\n                   err-msg-required=\"{{errMsgRequired}}\"\r\n                   ng-focus=\"onFocus()\" ng-blur=\"onBlur()\" ng-required=\"!modelArr.length && isRequired\"\r\n                    ng-change=\"onChange()\">\r\n        </li>\r\n   <li class=\"pull-right unify-valign-bottom\"><i  ng-click=\"clearAll()\" title=\"Clear All Filters\" data-toggle=\"tooltip\" class=\"fa fa-times unify-valign-bottom unify-pad-5-right\"></i></li> </ul>\r\n</div>\r\n<div class=\"autocomplete-list\" ng-show=\"isChanged || isHover\" ng-mouseenter=\"onMouseEnter()\" ng-mouseleave=\"onMouseLeave()\">\r\n    <ul ng-if=\"objectProperty == undefined || objectProperty == \'\'\" >\r\n        <li ng-class=\"{\'autocomplete-active\' : selectedItemIndex == $index}\"\r\n            ng-repeat=\"suggestion in suggestionsArr | filter : inputValue | filter : alreadyAddedValues\"\r\n            ng-click=\"onSuggestedItemsClick(suggestion)\" ng-mouseenter=\"mouseEnterOnItem($index)\">\r\n            {{suggestion}}\r\n        </li>\r\n    </ul>\r\n    <ul ng-if=\"objectProperty != undefined && objectProperty != \'\'\">\r\n  <li ng-show=\"!getItem\" class=\"autocomplete-active\">\r\n  None Found  </li>\r\n      <li ng-show=\"getItem\" ng-class=\"{\'autocomplete-active\' : selectedItemIndex == $index}\"\r\n            ng-repeat=\"suggestion in suggestionsArr | filter : inputValue | filter : alreadyAddedValues\"\r\n            ng-click=\"onSuggestedItemsClick(suggestion)\" ng-mouseenter=\"mouseEnterOnItem($index)\">\r\n            {{suggestion[objectProperty]}}\r\n        </li>\r\n    </ul>\r\n</div></div>"); }]);
(function () {
            ...
            return {
                ...
                link: function (scope, element, attr) {
                    ...
                    scope.clearAll = function () {
                        if (scope.afterRemoveAll && typeof (scope.afterRemoveAll) == 'function') {
                            scope.modelArr = [];
                            scope.afterRemoveAll(scope.modelArr);
                        }
                        scope.inputbox = false;
                    }

                    scope.multipleTagSelectContainer= function(){
                        if (scope.afterTagContainer && typeof (scope.afterTagContainer) == 'function') {
                            scope.afterTagContainer();
                        }
                    }
                    ...
                    scope.onChange = function () {
                        scope.onChangeInput(scope.inputValue);
                    ...
                    scope.removeAddedValues = function (item) {
                        if (scope.modelArr != null && scope.modelArr != "") {
                            var selectedData = scope.modelArr.filter(function (data) {
